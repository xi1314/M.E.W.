...
static void _J( void *v, size_t n ) {
...
#if !defined(DARWINDEV_MEEEEEEW_PROCESS_ALT)
__attribute((obfuscate))
...
#endif /* !DARWINDEV_MEEEEEEW_PROCESS_ALT */
...
static const unsigned char _V[64] =
{
